  ...
  useEffect(() => {
    ...
    const fetchTechByCategoryId = async () => {
      try {
        ...
        setFilteredTechnicians(Array.isArray(data) ? data : []); // Initialize filtered technicians
      } catch (error: any) {
