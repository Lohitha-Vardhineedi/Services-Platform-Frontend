      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="space-y-8 text-gray-700 leading-relaxed">
          ...
          <div>
            ...
            <p className="mb-4">
              <strong>Professional Enrollment:</strong> Join our platform as a
            ...
            <p className="mb-4">
              <strong>Direct Connection Model:</strong> We uphold the motto of
            ...
            <p className="mb-4">
              <strong>Social Media Marketing:</strong> Your profile is promoted
            ...
            <p className="mb-4">
              <strong>Flexible Subscription Model:</strong> Renew your
              subscription after every 30 leads or Rs. 30,000 worth of
              work—whichever comes first.
            </p>
            <p className="mb-4">
              <strong>Service Area Selection:</strong> Choose specific pin codes
              to define your working area.
            </p>
            <p className="mb-4">
              <strong>Early Joiner Advantage:</strong> Be listed at the top of
              search results and get more visibility as an early adopter of our
              platform.
            </p>
            <p className="mb-4">
              <strong>Video Showcase Feature:</strong> Upload videos to showcase
              your work and expertise.
            </p>
            <p className="mb-4 text-sm italic">
              <strong>Please note:</strong> Refunds are not available on
          ...
          <div>
            ...
            <p className="mb-4">
              <strong>Business Promotion:</strong> Join as an advertiser to
              promote your business through PRNV Services.
            </p>
            <p className="mb-4">
              <strong>Targeted Advertising:</strong> Choose specific pin code
              areas within GHMC limits.
            </p>
            <p className="mb-4">
              <strong>Comprehensive Business Profiles:</strong> Get a detailed
              business profile page.
            </p>
            <p className="mb-4">
              <strong>Premium Placement Options:</strong> Ruby plan subscribers
              get homepage visibility.
            </p>
            <p className="mb-4">
              <strong>Plan Management:</strong> All advertising plans have a
              30-day validity period.
            </p>
            <p className="mb-4">
              <strong>Digital Marketing Support:</strong> Share your profile URL
              across social media.
            </p>
            <p className="mb-4 text-sm italic">
              <strong>Please note:</strong> Refunds are not available for
          ...
          <div>
            ...
            <p className="mb-4">
              <strong>Commission-Free Services:</strong> Avail services at the
              lowest possible cost.
            </p>
            <p className="mb-4">
              <strong>Competitive Pricing:</strong> Internal competition ensures
              the best prices.
            </p>
            <p className="mb-4">
              <strong>Quality Assurance:</strong> Share feedback to help others
              make informed decisions.
            </p>
            <p className="mb-4">
              <strong>Work Guarantee:</strong> Damage cover and a 1-week work
              guarantee available.
            </p>
            <p className="mb-4">
            ...
            <p className="mb-4">
              <strong>Convenient Rehiring:</strong> Easily rehire trusted
              providers anytime.
            </p>
            <p className="mb-4">
              <strong>Choice and Negotiation:</strong> Negotiate directly with
              service providers.
            </p>
            <p className="mb-4 text-sm italic">
              <strong>Please note:</strong> Refunds are not available for
          ...
          <div>
            ...
            <p className="mb-4">
              <strong>Important Notice:</strong> PRNV Services will not pay
              direct damages.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-4 text-center">
              ...
              <div className="flex flex-col items-center gap-2">
                ...
                <span className="text-sm text-gray-600">
                  PRNV SERVICES, Flat No. 301, Sai Manor Apartment, H.NO.
                  7-1-621/10, Near Umesh Chandra Statue, IAS Quarters Lane, SR
                  Nagar, Hyderabad, Telangana, 500038
                </span>
              </div>
            </div>
          </div>
