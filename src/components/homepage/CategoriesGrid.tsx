  ...
  return (
    <div className="bg-white rounded-2xl shadow p-6 mb-12">
      ...
      <div className="grid grid-cols-3 md:grid-cols-6 gap-4">
        ...
        {/* More card */}
        <div className="relative rounded-xl shadow group cursor-pointer p-4 flex flex-col items-center transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 hover:bg-blue-50/60 hover:scale-105 animate-fade-in"
          style={{ animationDelay: `${11 * 60}ms`, animationFillMode: 'both' }}
        >
