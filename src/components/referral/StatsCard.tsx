...
import { StatsCardProps } from '../../pages/technician/TechnicianDashboard';
      ...
      <div className="p-6 relative z-10">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <div
              className={`p-3 ${color} rounded-full text-gray-600 group-hover:scale-110 transition-transform duration-300`}
            >
              {icon}
            </div>
            <div>
